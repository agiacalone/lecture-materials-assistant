...
% Bridge: pa-exam-build injects \def\answersmode{1} for the key build.
% If \answersmode is defined, flip \answerstrue. LaTeX-native \answerstrue still
% works directly if someone edits the .tex.
\makeatletter
