...
.bp-schematic {
  ...
  gap: 0.75rem;
  padding: 1.5rem 1rem;
  border: 1px solid var(--bp-border, rgba(51,255,138,0.18));
  border-radius: var(--bp-radius-lg, 4px);
  background: var(--bp-surface-1, rgba(51,255,138,0.04));
  /* Hairline grid inside the schematic frame */
  background-image:
    linear-gradient(var(--bp-hairline, rgba(51,255,138,0.07)) 1px, transparent 1px),
    linear-gradient(90deg, var(--bp-hairline, rgba(51,255,138,0.07)) 1px, transparent 1px);
...
.bp-schematic__node {
  ...
  background: var(--bp-bg, #0b0f0b);
  border: 1.5px solid var(--bp-accent, #33ff8a);
  border-radius: var(--bp-radius-md, 3px);
  box-shadow: 0 0 10px rgba(51,255,138,0.12), inset 0 0 8px rgba(51,255,138,0.04);
  position: relative;
  /* Corner ticks — terminal feel */
}
